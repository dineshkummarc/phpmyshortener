...
<body>
    <main>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="./index.html"><Strong>URL Shortener</Strong></a>
                <a class="navbar-brand" href="./domainchecker.php">Domain name checker</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Our Privacy Policy</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        ...
                        <p class="text-muted small mb-4 mb-lg-0">&copy; URL SHORTENER 2021. All Rights Reserved. Developed by <a href="mailto:oretnom23@gmail.com" target="_blank">oretnom23</a></p>
                    </div>
